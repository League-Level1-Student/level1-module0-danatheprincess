...
if(guess.equalsIgnoreCase("Arnold")) {
	...
	JOptionPane.showMessageDialog(null,"WRONG!!, the RIGHT answer is Arnold" );
}
		...
		if(guess.equalsIgnoreCase("Leonardo")){
			...
			JOptionPane.showMessageDialog(null,"WRONG!!!, the RIGHT answer is Leonardo");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("who is this?");
		if(guess.equalsIgnoreCase("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "WRONG!!!!, the RIGHT answer is Morgan");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("who is this?");
		...
		score+=1;
			...
			JOptionPane.showMessageDialog(null,"WRONG!!!, the RIGHT answer is Jack" );
		}
